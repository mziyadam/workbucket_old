...
<body id="regbg">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-input id="password" class="pw inform" type="password" name="password" placeholder="Password" required autocomplete="new-password" />
        </div>

        <!-- Confirm Password -->
        <div class="mt-4">

            <x-input id="password_confirmation" class="repw inform" type="password" placeholder="Confirm password" name="password_confirmation" required />
        </div>
